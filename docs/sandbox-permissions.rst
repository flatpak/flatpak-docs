...
If your app uses only the :doc:`XDG base directories`, then you do not need to add permissions for any access. The directories are mapped automatically to app specific directories in the user's home.
